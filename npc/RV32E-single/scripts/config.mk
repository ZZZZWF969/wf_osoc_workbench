# 移植自 NEMU：Kconfig 交互配置支持（make menuconfig）
# 依赖 NEMU 的 kconfig 工具链（tools/kconfig 与 tools/fixdep）
...
$(warning $(COLOR_RED)A default config will be generated, or run 'make menuconfig' to configure.$(COLOR_END))
endif
